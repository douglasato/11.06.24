...
INSERT INTO `db_douglas`.`cadastro_usuario` (`nome`, `idade`, `profissao`, `cidade`, `estado`, `nacionalidade`, `endereco`, `bairro`, `cep`, `cpf`, `rg`) 
VALUES ('Lucas Moraes', '22', 'desenvolvedor full stack', 'Londrina', 'PR', 'brasileiro', 'rua ronald walter sodre', 'Santa Luzia', '88.200-888', '080.121.064-96', '20.840.355-9');
